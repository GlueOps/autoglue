 ...
 */
export function instanceOfClustersClusterResponse(value: object): value is ClustersClusterResponse {
    return true;
}

export function ClustersClusterResponseFromJSON(json: any): ClustersClusterResponse {
    return ClustersClusterResponseFromJSONTyped(json, false);
}

export function ClustersClusterResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClustersClusterResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'bastion_server': json['bastion_server'] == null ? undefined : ClustersServerBriefFromJSON(json['bastion_server']),
        ...
        'node_pools': json['node_pools'] == null ? undefined : ((json['node_pools'] as Array<any>).map(ClustersNodePoolBriefFromJSON)),
...
export function ClustersClusterResponseToJSON(json: any): ClustersClusterResponse {
    return ClustersClusterResponseToJSONTyped(json, false);
}

export function ClustersClusterResponseToJSONTyped(value?: ClustersClusterResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'name': value['name'],
        'node_pools': value['node_pools'] == null ? undefined : ((value['node_pools'] as Array<any>).map(ClustersNodePoolBriefToJSON)),
