...
export function AuthnUserDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthnUserDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthnUserDTOToJSONTyped(value?: AuthnUserDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
