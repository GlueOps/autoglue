 ...
 */
export function instanceOfTaintsTaintResponse(value: object): value is TaintsTaintResponse {
    return true;
}
...
export function TaintsTaintResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaintsTaintResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'node_groups': json['node_groups'] == null ? undefined : ((json['node_groups'] as Array<any>).map(TaintsNodePoolBriefFromJSON)),
...
export function TaintsTaintResponseToJSONTyped(value?: TaintsTaintResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'key': value['key'],
        'node_groups': value['node_groups'] == null ? undefined : ((value['node_groups'] as Array<any>).map(TaintsNodePoolBriefToJSON)),
        'value': value['value'],
    };
}
