 ...
 */
export function instanceOfClustersNodePoolBrief(value: object): value is ClustersNodePoolBrief {
    return true;
}

export function ClustersNodePoolBriefFromJSON(json: any): ClustersNodePoolBrief {
    return ClustersNodePoolBriefFromJSONTyped(json, false);
}

export function ClustersNodePoolBriefFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClustersNodePoolBrief {
    if (json == null) {
        return json;
    }
    return {
        
        'annotations': json['annotations'] == null ? undefined : ((json['annotations'] as Array<any>).map(ClustersAnnotationBriefFromJSON)),
        'id': json['id'] == null ? undefined : json['id'],
        'labels': json['labels'] == null ? undefined : ((json['labels'] as Array<any>).map(ClustersLabelBriefFromJSON)),
        'name': json['name'] == null ? undefined : json['name'],
        'servers': json['servers'] == null ? undefined : ((json['servers'] as Array<any>).map(ClustersServerBriefFromJSON)),
        'taints': json['taints'] == null ? undefined : ((json['taints'] as Array<any>).map(ClustersTaintBriefFromJSON)),
    };
}
...
export function ClustersNodePoolBriefToJSONTyped(value?: ClustersNodePoolBrief | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'annotations': value['annotations'] == null ? undefined : ((value['annotations'] as Array<any>).map(ClustersAnnotationBriefToJSON)),
        'id': value['id'],
        'labels': value['labels'] == null ? undefined : ((value['labels'] as Array<any>).map(ClustersLabelBriefToJSON)),
        'name': value['name'],
        'servers': value['servers'] == null ? undefined : ((value['servers'] as Array<any>).map(ClustersServerBriefToJSON)),
        'taints': value['taints'] == null ? undefined : ((value['taints'] as Array<any>).map(ClustersTaintBriefToJSON)),
    };
}
