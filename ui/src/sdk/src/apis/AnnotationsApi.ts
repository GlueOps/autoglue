...
export class AnnotationsApi extends runtime.BaseAPI {
     ...
     */
    async addAnnotationToNodePoolsRaw(requestParameters: AddAnnotationToNodePoolsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AnnotationsAnnotationResponse>> {
        ...
        const response = await this.request({
            ...
            body: AnnotationsAddAnnotationToNodePoolToJSON(requestParameters['body']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => AnnotationsAnnotationResponseFromJSON(jsonValue));
    }
     ...
     * Attach annotation to node pools (org scoped)
     */
    async addAnnotationToNodePools(requestParameters: AddAnnotationToNodePoolsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AnnotationsAnnotationResponse> {
        const response = await this.addAnnotationToNodePoolsRaw(requestParameters, initOverrides);
     ...
     */
    async createAnnotationRaw(requestParameters: CreateAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AnnotationsAnnotationResponse>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: AnnotationsCreateAnnotationRequestToJSON(requestParameters['body']),
        }, initOverrides);
     ...
     * Create annotation (org scoped)
     */
    async createAnnotation(requestParameters: CreateAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AnnotationsAnnotationResponse> {
     ...
     */
    async getAnnotationRaw(requestParameters: GetAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AnnotationsAnnotationResponse>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Get annotation by ID (org scoped)
     */
    async getAnnotation(requestParameters: GetAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AnnotationsAnnotationResponse> {
     ...
     */
    async listAnnotationsRaw(requestParameters: ListAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<AnnotationsAnnotationResponse>>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(AnnotationsAnnotationResponseFromJSON));
    }
     ...
     * List annotations (org scoped)
     */
    async listAnnotations(requestParameters: ListAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<AnnotationsAnnotationResponse>> {
     ...
     */
    async listNodePoolsWithAnnotationRaw(requestParameters: ListNodePoolsWithAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<AnnotationsNodePoolBrief>>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(AnnotationsNodePoolBriefFromJSON));
    }
     ...
     * List node pools linked to an annotation (org scoped)
     */
    async listNodePoolsWithAnnotation(requestParameters: ListNodePoolsWithAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<AnnotationsNodePoolBrief>> {
        const response = await this.listNodePoolsWithAnnotationRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async removeAnnotationFromNodePoolRaw(requestParameters: RemoveAnnotationFromNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Detach annotation from a node pool (org scoped)
     */
    async removeAnnotationFromNodePool(requestParameters: RemoveAnnotationFromNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.removeAnnotationFromNodePoolRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateAnnotationRaw(requestParameters: UpdateAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AnnotationsAnnotationResponse>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: AnnotationsUpdateAnnotationRequestToJSON(requestParameters['body']),
        }, initOverrides);
     ...
     * Update annotation (org scoped)
     */
    async updateAnnotation(requestParameters: UpdateAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AnnotationsAnnotationResponse> {
