...
export class NodePoolsApi extends runtime.BaseAPI {
     ...
     */
    async attachNodePoolAnnotationsRaw(requestParameters: AttachNodePoolAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            ...
            body: NodepoolsAttachAnnotationsRequestToJSON(requestParameters['body']),
        }, initOverrides);
     ...
     * Attach annotations to a node pool (org scoped)
     */
    async attachNodePoolAnnotations(requestParameters: AttachNodePoolAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.attachNodePoolAnnotationsRaw(requestParameters, initOverrides);
     ...
     */
    async attachNodePoolLabelsRaw(requestParameters: AttachNodePoolLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Attach labels to a node pool (org scoped)
     */
    async attachNodePoolLabels(requestParameters: AttachNodePoolLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.attachNodePoolLabelsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async attachNodePoolServersRaw(requestParameters: AttachNodePoolServersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Attach servers to a node pool (org scoped)
     */
    async attachNodePoolServers(requestParameters: AttachNodePoolServersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.attachNodePoolServersRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async attachNodePoolTaintsRaw(requestParameters: AttachNodePoolTaintsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Attach taints to a node pool (org scoped)
     */
    async attachNodePoolTaints(requestParameters: AttachNodePoolTaintsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.attachNodePoolTaintsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async createNodePoolRaw(requestParameters: CreateNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NodepoolsNodePoolResponse>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => NodepoolsNodePoolResponseFromJSON(jsonValue));
    }
     ...
     * Create node group (org scoped)
     */
    async createNodePool(requestParameters: CreateNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NodepoolsNodePoolResponse> {
     ...
     */
    async deleteNodePoolRaw(requestParameters: DeleteNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Delete node pool (org scoped)
     */
    async deleteNodePool(requestParameters: DeleteNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.deleteNodePoolRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async detachNodePoolAnnotationRaw(requestParameters: DetachNodePoolAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Detach one annotation from a node pool (org scoped)
     */
    async detachNodePoolAnnotation(requestParameters: DetachNodePoolAnnotationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.detachNodePoolAnnotationRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async detachNodePoolLabelRaw(requestParameters: DetachNodePoolLabelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Detach one label from a node pool (org scoped)
     */
    async detachNodePoolLabel(requestParameters: DetachNodePoolLabelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.detachNodePoolLabelRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async detachNodePoolServerRaw(requestParameters: DetachNodePoolServerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Detach one server from a node pool (org scoped)
     */
    async detachNodePoolServer(requestParameters: DetachNodePoolServerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.detachNodePoolServerRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async detachNodePoolTaintRaw(requestParameters: DetachNodePoolTaintRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
        urlPath = urlPath.replace(`{${"taintId"}}`, encodeURIComponent(String(requestParameters['taintId'])));
     ...
     * Detach one taint from a node pool (org scoped)
     */
    async detachNodePoolTaint(requestParameters: DetachNodePoolTaintRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.detachNodePoolTaintRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getNodePoolRaw(requestParameters: GetNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NodepoolsNodePoolResponse>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Get node group by ID (org scoped)
     */
    async getNodePool(requestParameters: GetNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NodepoolsNodePoolResponse> {
        const response = await this.getNodePoolRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listNodePoolAnnotationsRaw(requestParameters: ListNodePoolAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<NodepoolsAnnotationBrief>>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(NodepoolsAnnotationBriefFromJSON));
    }

    /**
     * List annotations attached to a node pool (org scoped)
     */
    async listNodePoolAnnotations(requestParameters: ListNodePoolAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<NodepoolsAnnotationBrief>> {
        const response = await this.listNodePoolAnnotationsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listNodePoolLabelsRaw(requestParameters: ListNodePoolLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<NodepoolsLabelBrief>>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(NodepoolsLabelBriefFromJSON));
    }

    /**
     * List labels attached to a node pool (org scoped)
     */
    async listNodePoolLabels(requestParameters: ListNodePoolLabelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<NodepoolsLabelBrief>> {
        const response = await this.listNodePoolLabelsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listNodePoolServersRaw(requestParameters: ListNodePoolServersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<NodepoolsServerBrief>>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(NodepoolsServerBriefFromJSON));
    }

    /**
     * List servers attached to a node pool (org scoped)
     */
    async listNodePoolServers(requestParameters: ListNodePoolServersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<NodepoolsServerBrief>> {
        const response = await this.listNodePoolServersRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listNodePoolTaintsRaw(requestParameters: ListNodePoolTaintsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<NodepoolsTaintBrief>>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(NodepoolsTaintBriefFromJSON));
    }

    /**
     * List taints attached to a node pool (org scoped)
     */
    async listNodePoolTaints(requestParameters: ListNodePoolTaintsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<NodepoolsTaintBrief>> {
        const response = await this.listNodePoolTaintsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listNodePoolsRaw(requestParameters: ListNodePoolsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<NodepoolsNodePoolResponse>>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(NodepoolsNodePoolResponseFromJSON));
    }
     ...
     * List node pools (org scoped)
     */
    async listNodePools(requestParameters: ListNodePoolsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<NodepoolsNodePoolResponse>> {
        const response = await this.listNodePoolsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateNodePoolRaw(requestParameters: UpdateNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NodepoolsNodePoolResponse>> {
        if (requestParameters['xOrgID'] == null) {
            throw new runtime.RequiredError(
                'xOrgID',
     ...
     * Update node pool (org scoped)
     */
    async updateNodePool(requestParameters: UpdateNodePoolRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NodepoolsNodePoolResponse> {
        const response = await this.updateNodePoolRaw(requestParameters, initOverrides);
        return await response.value();
    }
