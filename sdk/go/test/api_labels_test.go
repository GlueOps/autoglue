...
func Test_autoglue_LabelsAPIService(t *testing.T) {
	...
	t.Run("Test LabelsAPIService AddLabelToNodePool", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.LabelsAPI.AddLabelToNodePool(context.Background(), id).Execute()
	...
	t.Run("Test LabelsAPIService ListNodePoolsWithLabel", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.LabelsAPI.ListNodePoolsWithLabel(context.Background(), id).Execute()
	...
	t.Run("Test LabelsAPIService RemoveLabelFromNodePool", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.LabelsAPI.RemoveLabelFromNodePool(context.Background(), id, poolId).Execute()
