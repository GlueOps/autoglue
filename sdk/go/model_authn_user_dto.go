...
// checks if the AuthnUserDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthnUserDTO{}

// AuthnUserDTO struct for AuthnUserDTO
type AuthnUserDTO struct {
...
func (o AuthnUserDTO) MarshalJSON() ([]byte, error) {
...
func (o AuthnUserDTO) ToMap() (map[string]interface{}, error) {
...
type NullableAuthnUserDTO struct {
	value *AuthnUserDTO
	isSet bool
}

func (v NullableAuthnUserDTO) Get() *AuthnUserDTO {
	return v.value
}

func (v *NullableAuthnUserDTO) Set(val *AuthnUserDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthnUserDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthnUserDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthnUserDTO(val *AuthnUserDTO) *NullableAuthnUserDTO {
	return &NullableAuthnUserDTO{value: val, isSet: true}
}

func (v NullableAuthnUserDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthnUserDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
