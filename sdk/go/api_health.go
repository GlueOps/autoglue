...
func (r ApiHealthCheckOperationIdRequest) Execute() (*HealthHealthStatus, *http.Response, error) {
...
func (a *HealthAPIService) HealthCheckOperationIdExecute(r ApiHealthCheckOperationIdRequest) (*HealthHealthStatus, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/healthz"
