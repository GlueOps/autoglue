 ...
 */
export function instanceOfAuthnAuthClaimsDTO(
  value: object,
): value is AuthnAuthClaimsDTO {
  return true;
}
...
export function AuthnAuthClaimsDTOFromJSONTyped(
  json: any,
...
export function AuthnAuthClaimsDTOToJSONTyped(
  value?: AuthnAuthClaimsDTO | null,
