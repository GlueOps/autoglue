 ...
 */
export function instanceOfClustersCreateClusterRequest(
  value: object,
): value is ClustersCreateClusterRequest {
  return true;
}

export function ClustersCreateClusterRequestFromJSON(
  json: any,
): ClustersCreateClusterRequest {
  return ClustersCreateClusterRequestFromJSONTyped(json, false);
}

export function ClustersCreateClusterRequestFromJSONTyped(
  json: any,
...
export function ClustersCreateClusterRequestToJSON(
  json: any,
): ClustersCreateClusterRequest {
  return ClustersCreateClusterRequestToJSONTyped(json, false);
}

export function ClustersCreateClusterRequestToJSONTyped(
  value?: ClustersCreateClusterRequest | null,
