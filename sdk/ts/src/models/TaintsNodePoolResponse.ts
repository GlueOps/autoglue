 ...
 */
export function instanceOfTaintsNodePoolResponse(
  value: object,
): value is TaintsNodePoolResponse {
  return true;
}

export function TaintsNodePoolResponseFromJSON(
  json: any,
): TaintsNodePoolResponse {
  return TaintsNodePoolResponseFromJSONTyped(json, false);
}

export function TaintsNodePoolResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    servers:
      json["servers"] == null
        ? undefined
        : (json["servers"] as Array<any>).map(TaintsServerBriefFromJSON),
  };
}

export function TaintsNodePoolResponseToJSON(
  json: any,
): TaintsNodePoolResponse {
  return TaintsNodePoolResponseToJSONTyped(json, false);
}

export function TaintsNodePoolResponseToJSONTyped(
  value?: TaintsNodePoolResponse | null,
  ...
  return {
    ...
    servers:
      value["servers"] == null
        ? undefined
        : (value["servers"] as Array<any>).map(TaintsServerBriefToJSON),
  };
}
