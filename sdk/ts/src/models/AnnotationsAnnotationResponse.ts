 ...
 */
export function instanceOfAnnotationsAnnotationResponse(
  value: object,
): value is AnnotationsAnnotationResponse {
  return true;
}

export function AnnotationsAnnotationResponseFromJSON(
  json: any,
): AnnotationsAnnotationResponse {
  return AnnotationsAnnotationResponseFromJSONTyped(json, false);
}

export function AnnotationsAnnotationResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    node_pools:
      json["node_pools"] == null
        ? undefined
        : (json["node_pools"] as Array<any>).map(
            AnnotationsNodePoolBriefFromJSON,
          ),
...
export function AnnotationsAnnotationResponseToJSON(
  json: any,
): AnnotationsAnnotationResponse {
  return AnnotationsAnnotationResponseToJSONTyped(json, false);
}

export function AnnotationsAnnotationResponseToJSONTyped(
  value?: AnnotationsAnnotationResponse | null,
  ...
  return {
    ...
    node_pools:
      value["node_pools"] == null
        ? undefined
        : (value["node_pools"] as Array<any>).map(
            AnnotationsNodePoolBriefToJSON,
          ),
    value: value["value"],
  };
