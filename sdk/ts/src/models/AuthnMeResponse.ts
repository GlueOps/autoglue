 ...
 */
export function instanceOfAuthnMeResponse(
  value: object,
): value is AuthnMeResponse {
  return true;
}
...
export function AuthnMeResponseFromJSONTyped(
  json: any,
  ...
  return {
    claims:
      json["claims"] == null
        ? undefined
        : AuthnAuthClaimsDTOFromJSON(json["claims"]),
    ...
    user_id:
      json["user_id"] == null
        ? undefined
        : AuthnUserDTOFromJSON(json["user_id"]),
  };
}
...
export function AuthnMeResponseToJSONTyped(
  value?: AuthnMeResponse | null,
