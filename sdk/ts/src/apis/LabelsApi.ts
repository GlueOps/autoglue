...
export class LabelsApi extends runtime.BaseAPI {
   ...
   */
  async addLabelToNodePoolRaw(
    requestParameters: AddLabelToNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<LabelsLabelResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      LabelsLabelResponseFromJSON(jsonValue),
    );
  }
   ...
   * Attach label to node pools (org scoped)
   */
  async addLabelToNodePool(
    requestParameters: AddLabelToNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<LabelsLabelResponse> {
    const response = await this.addLabelToNodePoolRaw(
      requestParameters,
      initOverrides,
    );
  ...
  async listLabelsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<LabelsLabelResponse>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(LabelsLabelResponseFromJSON),
    );
  }
  ...
  async listLabels(
    requestParameters: ListLabelsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<LabelsLabelResponse>> {
   ...
   */
  async listNodePoolsWithLabelRaw(
    requestParameters: ListNodePoolsWithLabelRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<LabelsNodePoolBrief>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(LabelsNodePoolBriefFromJSON),
    );
  }
   ...
   * List node pools linked to a label (org scoped)
   */
  async listNodePoolsWithLabel(
    requestParameters: ListNodePoolsWithLabelRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<LabelsNodePoolBrief>> {
    const response = await this.listNodePoolsWithLabelRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async removeLabelFromNodePoolRaw(
    requestParameters: RemoveLabelFromNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<string>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
   ...
   * Detach label from a node pool (org scoped)
   */
  async removeLabelFromNodePool(
    requestParameters: RemoveLabelFromNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<string> {
    const response = await this.removeLabelFromNodePoolRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
