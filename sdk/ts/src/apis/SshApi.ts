...
export class SshApi extends runtime.BaseAPI {
  ...
  async createSSHKeyRaw(
  ...
  ): Promise<runtime.ApiResponse<SshSshResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SshSshResponseFromJSON(jsonValue),
    );
  }
  ...
  async getSSHKeyRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SshSshRevealResponse>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SshSshRevealResponseFromJSON(jsonValue),
    );
  }
   ...
   */
  async listPublicKeysRaw(
    requestParameters: ListPublicKeysRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<SshSshResponse>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(SshSshResponseFromJSON),
    );
  }
  ...
  async listPublicKeys(
    requestParameters: ListPublicKeysRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<SshSshResponse>> {
    const response = await this.listPublicKeysRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
