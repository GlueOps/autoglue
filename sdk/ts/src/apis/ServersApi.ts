...
export class ServersApi extends runtime.BaseAPI {
  ...
  async createServerRaw(
  ...
  ): Promise<runtime.ApiResponse<ServersServerResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ServersServerResponseFromJSON(jsonValue),
    );
  }
  ...
  async listServersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ServersServerResponse>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ServersServerResponseFromJSON),
    );
  }
  ...
  async listServers(
    requestParameters: ListServersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ServersServerResponse>> {
