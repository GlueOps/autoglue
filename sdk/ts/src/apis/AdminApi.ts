...
export class AdminApi extends runtime.BaseAPI {
   ...
   * Admin: create user
   */
  async adminCreateUserRaw(
    requestParameters: AdminCreateUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AuthnUserOut>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuthnUserOutFromJSON(jsonValue),
    );
  }
  ...
  async adminCreateUser(
    requestParameters: AdminCreateUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AuthnUserOut> {
    const response = await this.adminCreateUserRaw(
      requestParameters,
      initOverrides,
    );
  ...
  async adminDeleteUser(
    ...
    const response = await this.adminDeleteUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async adminListUsersRaw(
    requestParameters: AdminListUsersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AuthnListUsersOut>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuthnListUsersOutFromJSON(jsonValue),
    );
  }
  ...
  async adminListUsers(
    requestParameters: AdminListUsersRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AuthnListUsersOut> {
    const response = await this.adminListUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async adminUpdateUser(
    ...
    const response = await this.adminUpdateUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
