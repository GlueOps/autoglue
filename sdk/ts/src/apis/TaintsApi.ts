...
export class TaintsApi extends runtime.BaseAPI {
   ...
   */
  async addTaintToNodePoolRaw(
    requestParameters: AddTaintToNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TaintsTaintResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TaintsTaintResponseFromJSON(jsonValue),
    );
  }
   ...
   * Attach taint to node pools (org scoped)
   */
  async addTaintToNodePool(
    requestParameters: AddTaintToNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TaintsTaintResponse> {
    const response = await this.addTaintToNodePoolRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async listNodePoolsWithTaintRaw(
    requestParameters: ListNodePoolsWithTaintRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<TaintsNodePoolResponse>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(TaintsNodePoolResponseFromJSON),
    );
  }
   ...
   * List node pools linked to a taint (org scoped)
   */
  async listNodePoolsWithTaint(
    requestParameters: ListNodePoolsWithTaintRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<TaintsNodePoolResponse>> {
    const response = await this.listNodePoolsWithTaintRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async listTaintsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<TaintsTaintResponse>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(TaintsTaintResponseFromJSON),
    );
  }
  ...
  async listTaints(
    requestParameters: ListTaintsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<TaintsTaintResponse>> {
   ...
   */
  async removeTaintFromNodePoolRaw(
    requestParameters: RemoveTaintFromNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<string>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
   ...
   * Detach taint from a node pool (org scoped)
   */
  async removeTaintFromNodePool(
    requestParameters: RemoveTaintFromNodePoolRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<string> {
    const response = await this.removeTaintFromNodePoolRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
