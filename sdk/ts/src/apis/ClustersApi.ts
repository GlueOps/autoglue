...
export class ClustersApi extends runtime.BaseAPI {
   ...
   */
  async attachNodePoolsRaw(
    requestParameters: AttachNodePoolsRequest,
   ...
   * Attach node pools to cluster (org scoped)
   */
  async attachNodePools(
    requestParameters: AttachNodePoolsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<string> {
    const response = await this.attachNodePoolsRaw(
      requestParameters,
      initOverrides,
    );
  ...
  async createClusterRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ClustersClusterResponse>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ClustersClusterResponseFromJSON(jsonValue),
    );
  }
  ...
  async createCluster(
    requestParameters: CreateClusterRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ClustersClusterResponse> {
   ...
   */
  async deleteBastionRaw(
    requestParameters: DeleteBastionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<string>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
  ...
  async deleteBastion(
    ...
    const response = await this.deleteBastionRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async getBastionRaw(
    requestParameters: GetBastionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ClustersServerBrief>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ClustersServerBriefFromJSON(jsonValue),
    );
  }
   ...
   */
  async listClusterNodePoolsRaw(
    requestParameters: ListClusterNodePoolsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ClustersNodePoolBrief>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ClustersNodePoolBriefFromJSON),
    );
  }
   ...
   * List node pools attached to a cluster (org scoped)
   */
  async listClusterNodePools(
    requestParameters: ListClusterNodePoolsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ClustersNodePoolBrief>> {
    const response = await this.listClusterNodePoolsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async listClustersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ClustersClusterResponse>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ClustersClusterResponseFromJSON),
    );
  }
  ...
  async listClusters(
    requestParameters: ListClustersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ClustersClusterResponse>> {
   ...
   */
  async putBastionRaw(
    requestParameters: PutBastionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<string>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
