...
export class JobsApi extends runtime.BaseAPI {
   ...
   */
  async jobsCancelRaw(
    requestParameters: JobsCancelRequest,
   ...
   */
  async jobsEnqueueRaw(
    requestParameters: JobsEnqueueRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<JobsEnqueueResp>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      JobsEnqueueRespFromJSON(jsonValue),
    );
  }
  ...
  async jobsEnqueue(
    requestParameters: JobsEnqueueRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<JobsEnqueueResp> {
    const response = await this.jobsEnqueueRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Active jobs
   */
  async jobsGetActiveRaw(
    requestParameters: JobsGetActiveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<JobsJobListItem>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(JobsJobListItemFromJSON),
    );
  }
  ...
  async jobsGetActive(
    requestParameters: JobsGetActiveRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<JobsJobListItem>> {
    const response = await this.jobsGetActiveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Recent failures
   */
  async jobsGetFailuresRaw(
    requestParameters: JobsGetFailuresRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<JobsJobListItem>>> {
    const queryParameters: any = {};
   ...
   * Recent failures
   */
  async jobsGetFailures(
    requestParameters: JobsGetFailuresRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<JobsJobListItem>> {
    const response = await this.jobsGetFailuresRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async jobsGetKPIRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<JobsKPI>> {
    const queryParameters: any = {};
   ...
   * Per-queue rollups
   */
  async jobsGetQueuesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<JobsQueueRollup>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(JobsQueueRollupFromJSON),
    );
  }
   ...
   */
  async jobsRetryNowRaw(
    requestParameters: JobsRetryNowRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<string>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  async jobsRetryNow(
    ...
    const response = await this.jobsRetryNowRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
