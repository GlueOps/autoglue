...
export class OrganizationsApi extends runtime.BaseAPI {
  ...
  async deleteMember(
    ...
    const response = await this.deleteMemberRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async deleteOrganization(
    ...
    const response = await this.deleteOrganizationRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async inviteMember(
    ...
    const response = await this.inviteMemberRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async listMembersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ModelsMember>>> {
    if (requestParameters["xOrgID"] == null) {
      throw new runtime.RequiredError(
        "xOrgID",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ModelsMemberFromJSON),
    );
  }
